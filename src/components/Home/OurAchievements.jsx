...
export default function OurAchievements() {
  ...
  return (
    <Element name="scroll-to-Achievements">
      <Container className={"mt-20 mb-20"}>
        <div className=" flex flex-col">
          <p className="mx-auto bg-purple-700 px-7 py-3 text-white rounded-full font-semibold text-xl">
            Our Achievements
          </p>
          <div className="flex flex-col md:flex-row gap-5 mt-3 md:mt-10">
            <div className="flex flex-col gap-6 mt-10 md:w-6/12 my-auto">
              ...
              <p className="text-xl ">
                ...
                data-driven approach to help businesses reach new heights with
